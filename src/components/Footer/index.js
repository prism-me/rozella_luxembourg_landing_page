    ...
    return (
      <React.Fragment>
        <footer className="footer-section">
          <div className={"footer-top background-img-2 py-5"}>
              ...
              <div className="row justify-content-between">
                <div className="col-lg-7">
                  <div className="footer-nav-wrap text-white mb-3">
                    ...
                    <p>ABLCC ( Arab-Belgian-Luxembourg Chamber of Commerce )</p>
                  </div>
                </div>
                    ...
                    <div className="social-list-wrap">
                      <ul className="social-list list-inline list-unstyled">
                        <li className="list-inline-item">
                          <a
                            href="https://m.facebook.com/rozellarealestate/?ref=py_c"
                            target="_blank"
                            title="Facebook"
                          >
                        ...
                        <li className="list-inline-item">
                          <a
                            href="https://www.linkedin.com/company/rosella-real-estate"
                            target="_blank"
                            title="LinkedIn"
                          >
                        ...
                        <li className="list-inline-item">
                          <a
                            href="https://www.instagram.com/rozellarealestate/?igshid=YmMyMTA2M2Y%3D"
                            target="_blank"
                            title="Instagram"
                          >
