                        ...
                        <div className="row align-items-center justify-content-between">
                            <div className="col-md-8 col-lg-8">
                                <div className="hero-content-left text-white mt-5">
                                    ...
                                    <p className="detail">6th - 8th October 2022 <br /> Le Royal Hotels and Resorts, 12 Bd Royal, 2449 Luxembourg</p>

                                    <a href="#" className="bannerBtn">Get Your Free Ticket Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
